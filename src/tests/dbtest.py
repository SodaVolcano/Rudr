...
class TestDBCase(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        msg2 = Messages(body="hello! how are you?",emotion="calm",speaker="robot",conversation_ID=0)
        msg3 = Messages(body="good king",emotion="calm",speaker="user",conversation_ID=0)
        msg4 = Messages(body="foobar!",emotion="calm",speaker="robot",conversation_ID=0)
